...
#     session added Limine, an unstable kdePackages overlay, nixvim, NUR and
...
if [ "$PREFLIGHT" = "1" ]; then
  msg "PREFLIGHT — proving the config builds before anything is erased"
...
!!! in this nixpkgs — the new Limine, KDE-unstable, nixvim, NUR and
